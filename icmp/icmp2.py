...
parser.add_argument("--log", dest="log_file", default="alerts.log", help="Path for alert logs")
parser.add_argument("--json-out", dest="json_output", default="alerts.json", help="JSON output file for alerts")
